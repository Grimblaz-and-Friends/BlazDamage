...
SlashCmdList["BLAZDAMAGE"] = function(msg)
    ...
    elseif cmd == "status" then
        ...
        print(PREFIX .. "  Tip Avg:    " .. (BD.config.tooltipShowAvg and "Enabled" or "Disabled"))
        print(PREFIX .. "  Tip DPS:    " .. (BD.config.tooltipShowDps and "Enabled" or "Disabled"))
        print(PREFIX .. "  Tip DPSC:   " .. (BD.config.tooltipShowDpsc and "Enabled" or "Disabled"))
        print(PREFIX .. "  Tip Crit:   " .. (BD.config.tooltipShowCrit and "Enabled" or "Disabled"))
        print(PREFIX .. "  Tip DPM:    " .. (BD.config.tooltipShowDpm and "Enabled" or "Disabled"))
